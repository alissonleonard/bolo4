                ...
                <div class="container">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6">
                            <img src="/bolo4/my_app_name/webroot/img/produtos/2.jpg" class="img-thumbnail" id="imgProduto">
                            <br class="clearfix">
                            <div class="row my-3 gx-3">
                                <div class="col-3">
                                    <img src="/bolo4/my_app_name/webroot/img/produtos/2.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                </div>
                                <div class="col-3">
                                    <img src="/bolo4/my_app_name/webroot/img/produtos/produtos_details2/02.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                </div>
                                <div class="col-3">
                                    <img src="/bolo4/my_app_name/webroot/img/produtos//produtos_details2/03.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                </div>
                                <div class="col-3">
                                    <img src="/bolo4/my_app_name/webroot/img/produtos/produtos_details2/04.jpg" class="img-thumbnail" onclick="trocarImagem(this)">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
